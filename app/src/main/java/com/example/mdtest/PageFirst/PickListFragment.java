...
import com.example.mdtest.Util.PickUtils;
...
public class PickListFragment extends Fragment {
    ...
    private static PickListFragment pickFragment;
    ...
    public static PickListFragment getNewInstance() {
        if (pickFragment == null) {
            pickFragment = new PickListFragment();
        }
        return pickFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_pick_list, container, false);
...
//            }
    ...
    private void initDeliveries() {
        ...
        PickUtils.setIPickListener(new PickUtils.IPick() {
            @Override
            public void getPickList(List<MyOrder> list) {
                if (list.size() == 0) {
