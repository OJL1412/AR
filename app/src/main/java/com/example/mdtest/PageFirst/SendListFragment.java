...
import com.example.mdtest.Util.SendUtils;
...
public class SendListFragment extends Fragment {
    ...
    private static SendListFragment sendFragment;
    ...
    public static SendListFragment getNewInstance() {
        if (sendFragment == null) {
            sendFragment = new SendListFragment();
        }
        return sendFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_send_list, container, false);
            recyclerView = rootView.findViewById(R.id.recycle_view_send);
...
//            }
            ...
            fab = rootView.findViewById(R.id.fab_send);
            swipeRefresh = rootView.findViewById(R.id.swipe_refresh_send);
    ...
    private void initDeliveries() {
        ...
        SendUtils.queryTakeList();

        SendUtils.setISendListener(new SendUtils.ISend() {
            @Override
            public void getSendList(List<MyOrder> list) {
                if (list.size() == 0) {
