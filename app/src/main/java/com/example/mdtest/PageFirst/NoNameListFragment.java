...
import com.example.mdtest.Util.NoNameUtils;
...
public class NoNameListFragment extends Fragment {
    private View rootView;      //缓存Fragment view
    private static NoNameListFragment noNameFragment;
    ...
    public NoNameListFragment() {
    }

    public static NoNameListFragment getNewInstance() {
        if (noNameFragment == null) {
            noNameFragment = new NoNameListFragment();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_no_name_list, container, false);
            recyclerView = rootView.findViewById(R.id.recycle_view_noName);
...
//            }
            ...
            fab = rootView.findViewById(R.id.fab_noName);
            swipeRefresh = rootView.findViewById(R.id.swipe_refresh_noName);
    ...
    private void initDeliveries() {
        ...
        NoNameUtils.queryTakeList();

        NoNameUtils.setINnListener(new NoNameUtils.INn() {
            @Override
            public void getNnList(List<MyOrder> list) {
                if (list.size() == 0) {
