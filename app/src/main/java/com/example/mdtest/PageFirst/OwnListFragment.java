...
import com.example.mdtest.Util.OwnUtils;
...
public class OwnListFragment extends Fragment {
    ...
    private static OwnListFragment ownFragment;
    ...
    public static OwnListFragment getNewInstance() {
        if (ownFragment == null) {
            ownFragment = new OwnListFragment();
        }
        return ownFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_own_list, container, false);
            recyclerView = rootView.findViewById(R.id.recycle_view_own);
...
//            }
            ...
            fab = rootView.findViewById(R.id.fab_own);
            swipeRefresh = rootView.findViewById(R.id.swipe_refresh_own);
    ...
    private void initDeliveries() {
        ...
        OwnUtils.queryTakeList();

        OwnUtils.setIOwnListener(new OwnUtils.IOwn() {
            @Override
            public void getOwnList(List<MyOrder> list) {
                if (list.size() == 0) {
